...
PREDICT2_VIDEO2WORLD_PIPELINE_2B = Video2WorldPipelineConfig(
    ...
    resize_online=False, # Modified to keep original resolution
    resolution="720",
...
PREDICT2_VIDEO2WORLD_PIPELINE_14B = Video2WorldPipelineConfig(
    ...
    tokenizer=L(TokenizerInterface)(
        ...
        load_mean_std=False,
        name="tokenizer",
        vae_pth=f"{get_data_folder()}/checkpoints/nvidia/Cosmos-Predict2-14B-Video2World/tokenizer/tokenizer.pth",
    ),
    prompt_refiner_config=CosmosReason1Config(
        checkpoint_dir=f"{get_data_folder()}/checkpoints/nvidia/Cosmos-Reason1-7B",
        offload_model_to_cpu=True,
