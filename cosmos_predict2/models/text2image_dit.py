...
class VideoRopePosition3DEmb(VideoPositionEmb):
    ...
    def generate_embeddings(
        ...
        # seq_h = torch.nn.functional.interpolate(self.seq.view(1, 1, -1), size=H, mode='linear', align_corners=True)[0][0]
        # seq_w = torch.nn.functional.interpolate(self.seq.view(1, 1, -1), size=W, mode='linear', align_corners=True)[0][0]
